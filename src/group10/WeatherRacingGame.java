...
class GamePanel extends JPanel implements ActionListener, KeyListener, MouseListener {
	...
	private enum ScreenState {MENU, GAME, SUMMARY}
	...
	private final Rectangle menuStartButton = new Rectangle(500, 300, 280, 60);
	private final Rectangle menuExitButton = new Rectangle(500, 385, 280, 60);
	...
	static class Car {
		...
		Car(double x, double y, Color color, String label) {
			this.x = x;
			this.y = y;
			this.color = color;
			this.label = label;
	...
	static class Puddle {
		int x, y, w, h;
		Puddle(int x, int y, int w, int h) {
			this.x = x;
			this.y = y;
			this.w = w;
			this.h = h;
